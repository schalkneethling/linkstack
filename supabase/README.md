...
- Existing environments also need `supabase/migrations/20260409_add_public_stack_resource_id.sql` so approved public stacks can resolve their public URLs without reading private bookmark rows.
